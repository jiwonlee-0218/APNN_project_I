...
def dataloader(args):
    ...
    train_timeseries, train_label = torch.load('../data/train_hcp-task_roi-aal.pth')
    subtask_label = np.load('../data/subtask_labels_detail.npy', allow_pickle=True).item()
    test_timeseries, test_label = torch.load('../data/test_hcp-task_roi-aal.pth')
